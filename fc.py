...
def fully_connected(num_pix, num_classes):
    ...
    W_fc1 = tf.Variable(tf.truncated_normal([num_pix, 600], stddev=0.1), name='fc1_weights')
    b_fc1 = tf.Variable(tf.truncated_normal([600], stddev=0.1), name='fc1_biases')
    W_fc2 = tf.Variable(tf.truncated_normal([600, 100], stddev=0.1), name='fc2_weights')
    b_fc2 = tf.Variable(tf.truncated_normal([100], stddev=0.1), name='fc2_biases')
    W_fc3 = tf.Variable(tf.truncated_normal([100, num_classes], stddev=0.1), name='fc3_weights')
...
saver = tf.train.Saver({'W_fc1':fc['W_fc1'], 'W_fc2':fc['W_fc2'], 'W_fc3':fc['W_fc3'], 'b_fc1':fc['b_fc1'], 'b_fc2':fc['b_fc2'], 'b_fc3':fc['b_fc3']})
